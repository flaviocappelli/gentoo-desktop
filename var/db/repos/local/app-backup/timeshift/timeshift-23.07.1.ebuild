...
# by F.C.
# Copied from the 'guru' overlay and modified the 'x11-libs/xapp'
# dependency (xapp >= 2.8.5 has the USE flag 'vala' that must be
# enabled, otherwise 'timeshift' fails to build).
