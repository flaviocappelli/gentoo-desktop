...
# by F.C.
#
# Copied from the 'khoverlay' overlay. Qt5 has been removed
# from Portage, but I still need it for software development.
# The 'stuff' overlay provides updated versions of some Qt5
# packages. However it does not provide dev-qt/qt-docs:5.
