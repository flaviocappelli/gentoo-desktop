...
# by F.C.
# Generated with "pycargoebuild -L -o ellama-0.4.0.ebuild ./"
# (missing parts has been imported from ellama-0.3.1.ebuild).
...
src_install() {
	...
	# Needs 'inherit desktop'.
	domenu "${FILESDIR}/ellama.desktop"
	doicon -s scalable "${FILESDIR}/ellama.svg"
}
