...
# by F.C.
# Copied from portage with some modifications (see patches below).
# The current version in portage does not work in PLASMA6!
...
PATCHES=(
	# by F.C.
	# from Arch
	"${FILESDIR}/${PN}-0.15_p20171022-fake-user-agent.patch"
	"${FILESDIR}/${PN}-0.15_p20171022-disable-tests-r1.patch"

	# from openSUSE
    # NOTE: "fix-username-field-reading.patch" removed (in PLASMA6 with this patch applied
    # signon-ui does not work, i.e. it does not show the sign-in page to Google accounts).
